...
If ${city} in this ${country} exists, create a list of things that a young couple (about 30 years old) who loves sport, hiking and good food can do in this ${city},${country}. 
...
export const generateTourImage = async ({ city, country }) => {
  try {
    const tourImage = await openai.images.generate({
      prompt: `a panoramic view ot the city of ${city} in ${country}`,
      n: 1,
      size: "512x512",
    });
